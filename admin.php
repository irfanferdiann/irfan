        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
             ...
             <li class="nav-item">
              <a class="nav-link mr-4" href="pesanan.php">CART</a>
            </li>
            <li class="nav-item">
  ...
  <!-- Menu -->    
      <div class="container">
        <div class="judul text-center mt-5">
            ...
            <h3 class="font-weight-bold">DIN'S RESTO</h3>

          <h5>JL. DAAN MOGOT, JAKARTA BARAT
          <br>Buka Jam <strong>11:00 - 20:00</strong></h5>
        </div>

        <div class="row mb-5 mt-5 ">
          <div class="col-md-6 d-flex justify-content-end">
            <div class="card bg-dark text-white border-light">
              <img src="images/background/bgg.jpg" class="card-img" alt="Lihat Daftar Menu">
              <div class="card-img-overlay mt-5 text-center">
               <a href="daftar_menu.php" class="btn btn-primary">EDIT DAFTAR MENU</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-6 d-flex justify-content-start">
            <div class="card bg-dark text-white border-light">
              <img src="images/background/bg7.jpg" class="card-img" alt="Lihat Pesanan">
              <div class="card-img-overlay mt-5 text-center">
               <a href="pesanan.php" class="btn btn-primary">LIHAT PESANAN PELANGGAN</a>
              </div>
            </div>
          </div>
        </div>
